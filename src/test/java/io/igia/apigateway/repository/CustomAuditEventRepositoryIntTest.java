 ...
 */
package io.igia.apigateway.repository;
...
import io.igia.apigateway.config.Constants;
import io.igia.apigateway.config.audit.AuditEventConverter;
import io.igia.apigateway.domain.PersistentAuditEvent;
import io.igia.apigateway.repository.CustomAuditEventRepository;
import io.igia.apigateway.repository.PersistenceAuditEventRepository;
...
import static io.igia.apigateway.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
...
public class CustomAuditEventRepositoryIntTest {
    ...
    @Test
    public void addAuditEventLargeData() {
        Map<String, Object> data = new HashMap<>();
        ...
        assertThat(actualData.length()).isEqualTo(EVENT_DATA_COLUMN_MAX_LENGTH + 10);
        assertThat(persistentAuditEvent.getAuditEventDate()).isEqualTo(event.getTimestamp());
    }
